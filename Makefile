...
LINUX_USER := platform/linux/user/platform-linux-user.c

.PHONY: all clean test basic integration integration-targets integration-freertos integration-baremetal ready-linux5 ready-to-play utilities ping membench transport-bench stat list-platforms
...
test: all ready-linux5 utilities
	./build/zipc-basic
